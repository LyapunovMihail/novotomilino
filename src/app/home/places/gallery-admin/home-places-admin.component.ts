...
import { HomePlacesAdminService } from './home-places-admin.service';
...
@Component({
    ...
    templateUrl: './home-places-admin.component.html',
    styleUrls: [
        './home-places-admin.component.scss'
    ],
    providers: [
        Uploader,
        HomePlacesAdminService
    ]
})

export class HomePlacesAdminComponent {
    ...
    constructor(
        private galleryAdminService: HomePlacesAdminService
    ) { }
    ...
    public setSlides(e) {
        ...
        this.galleryAdminService.imageUpload(fileList, EnumGallerySnippet.PLACES).then((arr: IGallerySnippet[]) => {
