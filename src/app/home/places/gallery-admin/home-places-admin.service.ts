...
import { HomePlacesAdminUpload } from './home-places-admin.upload';
...
export class HomePlacesAdminService {
    ...
    changeImage(id, e) {
        return new Promise((resolve, reject) => {
            ...
            const myUploadItem = new HomePlacesAdminUpload(url, fileList[0], id);
    ...
    imageUpload(fileList: FileList, type) {
        return new Promise((resolve, reject) => {
            ...
            const upload = (i) => {
                ...
                const myUploadItem = new HomePlacesAdminUpload(url, fileList[i], type);
                myUploadItem.formData = { FormDataKey: 'Form Data Value' };
                this.uploaderService.upload(myUploadItem);
            };
