...
import { HomeGalleryAdminUpload } from './home-gallery-admin.upload';
...
export class HomeGalleryAdminService {
    ...
    changeImage(id, e) {
        return new Promise((resolve, reject) => {
            ...
            const myUploadItem = new HomeGalleryAdminUpload(url, fileList[0], id);
    ...
    imageUpload(fileList: FileList, type) {
        return new Promise((resolve, reject) => {
            ...
            const upload = (i) => {
                ...
                const myUploadItem = new HomeGalleryAdminUpload(url, fileList[i], type);
                myUploadItem.formData = { FormDataKey: 'Form Data Value' };
                this.uploaderService.upload(myUploadItem);
            };
